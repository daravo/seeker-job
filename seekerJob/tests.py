...
class CanalTestCase(TestCase):
    def setUp(self):
        self.usuario_a= User.objects.create(username="unousuario", password="hola")
        self.usuario_b= User.objects.create(username="dosusuario", password="adios")
        self.usuario_c= User.objects.create(username="tresusuario", password="hola")
